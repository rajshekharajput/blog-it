...
class Askpass {
    ...
    getEnv() {
        ...
        return Object.assign(Object.assign({}, this.ipc.getEnv()), { GIT_ASKPASS: path.join(__dirname, 'askpass.sh'), VSCODE_GIT_ASKPASS_NODE: process.execPath, VSCODE_GIT_ASKPASS_MAIN: path.join(__dirname, 'askpass-main.js') });
    }
