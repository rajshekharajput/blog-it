...
class SyncStatusBar {
    constructor(repository, remoteSourceProviderRegistry) {
        ...
        (0, util_1.anyEvent)(remoteSourceProviderRegistry.onDidAddRemoteSourceProvider, remoteSourceProviderRegistry.onDidRemoveRemoteSourceProvider)(this.onDidChangeRemoteSourceProviders, this, this.disposables);
    ...
    updateEnablement() {
        ...
        this.state = Object.assign(Object.assign({}, this.state), { enabled });
    }
    onDidChangeOperations() {
        const isSyncRunning = this.repository.operations.isRunning("Sync") ||
            this.repository.operations.isRunning("Push") ||
            this.repository.operations.isRunning("Pull");
        this.state = Object.assign(Object.assign({}, this.state), { isSyncRunning });
    }
    onDidRunGitStatus() {
        this.state = Object.assign(Object.assign({}, this.state), { hasRemotes: this.repository.remotes.length > 0, HEAD: this.repository.HEAD });
    }
    onDidChangeRemoteSourceProviders() {
        this.state = Object.assign(Object.assign({}, this.state), { remoteSourceProviders: this.remoteSourceProviderRegistry.getRemoteProviders()
                .filter(p => !!p.publishRepository) });
    }
    get command() {
