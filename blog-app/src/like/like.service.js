...
var LikeService = /** @class */ (function () {
    function LikeService(likeRepository, postService, userService) {
        this.likeRepository = likeRepository;
        this.postService = postService;
        this.userService = userService;
    }
    LikeService.prototype.likePost = function (likeDto) {
        return __awaiter(this, void 0, void 0, function () {
            var like, newLike;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        like = new like_entity_1.Like();
                        like.user = likeDto.userId;
                        like.post = likeDto.postId;
                        return [4 /*yield*/, this.likeRepository.save(like)];
                    case 1:
                        newLike = _a.sent();
                        return [4 /*yield*/, this.likeRepository.findOne(newLike.id, { relations: ['post'] })];
