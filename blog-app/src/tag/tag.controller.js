...
var TagController = /** @class */ (function () {
    ...
    TagController.prototype.create = function (tagDto) {
        return this.tagService.createTag(tagDto);
    };
    TagController.prototype["delete"] = function (tagId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.tagService.deleteTag(tagId)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    TagController.prototype.getTagById = function (tagId) {
    ...
    ], TagController.prototype, "delete");
    __decorate([
        (0, common_1.Get)('tag/:tagId'),
        __param(0, (0, common_1.Param)('tagId', new common_1.ParseIntPipe()))
    ], TagController.prototype, "getTagById");
    __decorate([
        (0, common_1.Get)()
    ], TagController.prototype, "getAllTags");
