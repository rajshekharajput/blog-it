...
var TagService = /** @class */ (function () {
    ...
    TagService.prototype.createTag = function (tagDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.tagRepository.save(tag)];
            });
        });
    };
    TagService.prototype.deleteTag = function (tagId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.tagRepository["delete"](tagId)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    TagService.prototype.findById = function (tagId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.tagRepository.findOne(tagId)];
            });
        });
    };
